...
def prompt_generation_list_categorical(
    ...
    def get_choices(_answer_value, _df, _pk_column):
        if f'{url}_{_answer_value}_list_categorical' in choices_cache:
            cached_choices = choices_cache[f'{url}_{_answer_value}_list_categorical']
            return {
        ...
        choices_cache[f'{url}_{_answer_value}_list_categorical'] = choices
        return {
